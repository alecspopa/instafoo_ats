...
ActiveRecord::Schema[8.0].define(version: 2025_06_15_191709) do
  ...
  create_table "job_event_mappings", force: :cascade do |t|
    t.bigint "job_id", null: false
    t.bigint "job_event_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["job_event_id"], name: "index_job_event_mappings_on_job_event_id"
    t.index ["job_id"], name: "index_job_event_mappings_on_job_id", unique: true
  end
